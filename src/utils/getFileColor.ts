import { programmingExtensions, imageExtensions, archiveExtensions, wordExtensions, excelExtensions, powerpointExtensions, videoExtensions } from "./fileExtensions";
...
export const getFileColor = (extension: string) => {
    ...
    return colorFileTypeMap[extension] || null;
}