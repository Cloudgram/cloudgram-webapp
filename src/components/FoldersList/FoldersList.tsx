...
export const FoldersList = () => {
    ...
    const handleDelete = async (id: string | number, isFolder: boolean) => {
        if (isFolder) {
    ...
    const handleFolderDoubleClick = (e: React.MouseEvent, link: string) => {
        e.preventDefault();
        navigate(link);
    };

    const toggleMenu = (id: number, isFolder: boolean) => {
        if (isFolder) {
    ...
    return (
                    ...
                    >
                        ...
                        >
                            <path
                                fillRule='evenodd'
                                clipRule='evenodd'
                                d='M0 0H15V1H0V0ZM0 7H15V8H0V7ZM15 14H0V15H15V14Z'
                                fill='#B0C0D0'
                            />
                        </svg>
                    </button>
                        ...
                        foldersList.map((folder, index) => (
                            ...
                            >
                                <div className={styles.folders__item}>
                                    <div className={styles.folder__icons}>
                                        ...
                                        <button
                                            ...
                                            onClick={() => toggleMenu(folder.id, true)}
                                        >
                                            <svg
                                                width='3'
                                                height='15'
                                ...
                                {activeFolderMenuId === folder.id && (
                                    <FolderActionMenu
                                        menuRef={menuRef}
                                        onDelete={() => handleDelete(folder.id, true)}
                                    />
                                )}
                            </li>
                        ))}
                                ...
                                >
                                    <div className={styles.folders__item}>
                                        <div className={styles.folder__icons}>
                                            ...
                                            <button
                                                className={styles.more__actions__button}
                                                onClick={() => toggleMenu(file.id, false)}
                                            >
                                                <svg
                                                    width='3'
                                                    height='15'
                            ...
                            >
                                <div className={styles.folders__item_line}>
                                    <div className={styles.folder__icons_line}>
                                        ...
                                        <span className={styles.folder__title_line}>
                                            {folder.title}
                                        </span>
                                    </div>
                                    ...
                                    <div className={styles.actions__menu}>
                                        <button
                                            ...
                                            onClick={() => handleDelete(folder.id.toString(), true)}
                                        >
                                            <svg
                                                xmlns='http://www.w3.org/2000/svg'
                                    ...
                                    <div className={styles.folders__item_line}>
                                        ...
                                        <div className={styles.actions__menu}>
                                            ...
                                            <button
                                                className={styles.action__button}
                                                onClick={() =>
                                                    handleDelete(file.id.toString(), false)
                                                }
                                            >
                                                <svg
                                                    xmlns='http://www.w3.org/2000/svg'
        ...
        // <div className={styles.folderslist__container}></div>
    );
};
