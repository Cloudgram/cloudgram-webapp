...
import { useAppDispatch, useAppSelectot } from '@app/store/config/store';
...
import { SearchInput } from '@/features/search/ui/SearchInput/index';
                ...
                <div className={styles.header__user} onClick={() => toggleUserPanel()}>
                    ...
                    <div className={styles.icon__container}>
                        {user?.avatar ? (
                            ...
                            generateUserIcon(user?.full_name ?? '', styles.user__avatar_no)
                        )}
                    </div>
                    <div className={styles.header__username}>
                        <span
                            className={styles.full__name}
                            style={premium ? { color: 'white' } : { color: 'black' }}
                        >
                            {user?.full_name}
                            {premium && (
                                <svg
